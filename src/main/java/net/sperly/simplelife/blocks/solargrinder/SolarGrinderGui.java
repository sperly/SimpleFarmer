...
public class SolarGrinderGui extends GuiContainer {
    public static final int WIDTH = 180;
    public static final int HEIGHT = 152;

    private static final ResourceLocation background = new ResourceLocation(SimpleLife.MODID, "textures/gui/solargrindergui.png");
